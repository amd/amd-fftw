...
void X(cpy2d_pair_avx512)(R *I0, R *I1, R *O0, R *O1,
...
#else//cpy2d-pair_avx Ends. Dynamic Dispatcher Ends.
        ...
        case 1:
        {
            ...
            switch(t0 | (t1 << 1) | (t2 << 2) | (t3 << 3))
            {
              ...
              for (i1 = 0; i1 < n1; ++i1)
              {
                  ...
                  for (i0 = 0; i0 < n0; i0+=8) 
                  {
 		    in512 = _mm512_loadu_pd((float const *)&I[i0 * is0 + i1 * is1]);
                    _mm512_storeu_pd((float *)&O[i0 * os0 + i1 * os1], in512);
                  }
                  for (; i0 < (n0+n0_rem); i0++) 
                  {
                    R x0 = I[i0 * is0 + i1 * is1];
        ...
        case 1:
        {
            ...
            case 15://is0=2 and os0=2. Also is1=2, os1=2. Both 256-bit read and 256-bit write possible
                ...
                for (i1 = 0; i1 < n1; ++i1)
                {
                    ...
                    {
                        t0 = i0 * is0 + i1 * is1;
                        in512_1 = _mm512_loadu_pd((double const *)&I[t0]);
                        t0 += (is0 << 2);
                        in512_2 = _mm512_loadu_pd((double const *)&I[t0]);
                        t0 = i0 * os0 + i1 * os1;
                        _mm512_storeu_pd ((double *)&O[t0], in512_1);
                        t0 += (os0 << 2);
                        _mm512_storeu_pd ((double *)&O[t0], in512_2);
                    }
                    if (t1) 
                    {
                        t0 = i0 * is0 + i1 * is1;
